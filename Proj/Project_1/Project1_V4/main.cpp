...
int main(int argc, char** argv) {
    ...
    do{
        ...
        cout<<"Fire at: A"; //Fire at A#
            cin>>fire;
            if ((fire<1||fire>10)||(fire==cShip1&&cS1==false)|| //Can't Fire at Sunk Ship
                                   (fire==cShip2&&cS2==false)){
                cout<<"Invalid!"<<endl; //Output If Invalid
            }
        }while ((fire<1||fire>10)||(fire==cShip1&&cS1==false)||
                                   (fire==cShip2&&cS2==false));  //Input Validation
        ...
        if ((tries<=10)&&(cS1==true||cS2==true)&&
            ...
            do{
                ...
                if (cFire==ship1&&s1==true){  //Did Ship 1 Get Hit
                    ...
                    cout<<'A'<<cFire<<" OPONENT MISSED!";  //Output If No Ships Were Hit
